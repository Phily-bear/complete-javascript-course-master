...
class App {
  ...
  constructor() {
    ...
    // 'The 'this' keyword of the function which in the event listener is the element which the event attaches
  ...
  _loadMap(position) {
    ...
    // We can do  _renderWorkoutMarker only after the map is loaded.
